...
本文件是 `other_projects/cherry/net/proto/` 的局部索引。进入本目录工作时，先读本文件，再按需读取相邻源码、测试或上级文档。
...
- [`README.md`](README.md)
- [`build.bat`](build.bat)
- [`cluster_packet.go`](cluster_packet.go)
- [`cluster_packet_test.go`](cluster_packet_test.go)
- [`proto.go`](proto.go)
