...
本文件是 `other_projects/GameServer/docs/superpowers/plans/` 的局部索引。进入本目录工作时，先读本文件，再按需读取相邻源码、测试或上级文档。
...
- [`2026-06-21-server-bootstrap-implementation.md`](2026-06-21-server-bootstrap-implementation.md)
