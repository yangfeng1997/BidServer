...
本文件是 `other_projects/GameServer/docs/superpowers/specs/` 的局部索引。进入本目录工作时，先读本文件，再按需读取相邻源码、测试或上级文档。
...
- [`2025-06-21-server-bootstrap-design.md`](2025-06-21-server-bootstrap-design.md)
- [`2026-06-21-config-system-refactor.md`](2026-06-21-config-system-refactor.md)
- [`config-system-reference.md`](config-system-reference.md)
