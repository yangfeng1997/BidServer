...
本文件是 `other_projects/GameServer/tools/e2e_full/` 的局部索引。进入本目录工作时，先读本文件，再按需读取相邻源码、测试或上级文档。
...
- [`cross_bench_test.go`](cross_bench_test.go)
- [`flood_test.go`](flood_test.go)
- [`main_test.go`](main_test.go)
- [`profile_test.go`](profile_test.go)
- [`real_test.go`](real_test.go)
