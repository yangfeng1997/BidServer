...
本文件是 `other_projects/GameServer/internal/gatesvr/` 的局部索引。进入本目录工作时，先读本文件，再按需读取相邻源码、测试或上级文档。
...
- [`gate_accept.go`](gate_accept.go)
- [`gate_forward.go`](gate_forward.go)
- [`gateserver.go`](gateserver.go)
