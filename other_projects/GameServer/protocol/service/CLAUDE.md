...
本文件是 `other_projects/GameServer/protocol/service/` 的局部索引。进入本目录工作时，先读本文件，再按需读取相邻源码、测试或上级文档。
...
- [`match_service.proto`](match_service.proto)
- [`online_service.proto`](online_service.proto)
- [`room_service.proto`](room_service.proto)
