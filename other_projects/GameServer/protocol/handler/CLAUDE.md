...
本文件是 `other_projects/GameServer/protocol/handler/` 的局部索引。进入本目录工作时，先读本文件，再按需读取相邻源码、测试或上级文档。
...
- [`match_handler.proto`](match_handler.proto)
- [`online_handler.proto`](online_handler.proto)
- [`room_handler.proto`](room_handler.proto)
