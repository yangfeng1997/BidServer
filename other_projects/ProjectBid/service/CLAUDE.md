...
本文件是 `other_projects/ProjectBid/service/` 的局部索引。进入本目录工作时，先读本文件，再按需读取相邻源码、测试或上级文档。
...
- [../CLAUDE.md](../CLAUDE.md)
- [ProjectBid/CLAUDE.md](../CLAUDE.md)
...
- [`component_handler.go`](component_handler.go)
- [`handler_pool.go`](handler_pool.go)
- [`handler_service.go`](handler_service.go)
- [`remote_service.go`](remote_service.go)
