...
本文件是 `other_projects/pitaya/service/` 的局部索引。进入本目录工作时，先读本文件，再按需读取相邻源码、测试或上级文档。
...
- [`base_service.go`](base_service.go)
- [`handler.go`](handler.go)
- [`handler_pool.go`](handler_pool.go)
- [`handler_pool_test.go`](handler_pool_test.go)
- [`handler_test.go`](handler_test.go)
- [`remote.go`](remote.go)
- [`remote_test.go`](remote_test.go)
- [`util.go`](util.go)
