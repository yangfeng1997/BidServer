...
本文件是 `other_projects/pitaya/deploy/kubernetes/` 的局部索引。进入本目录工作时，先读本文件，再按需读取相邻源码、测试或上级文档。
...
- [`example-backend.yaml`](example-backend.yaml)
- [`example-frontend.yaml`](example-frontend.yaml)
