...
Examples:
  python scripts/config_bake.py --values config/values/dev.yaml --in config/gate.yaml --out run/gatesvr/conf/gate.yaml
  python scripts/config_bake.py --values config/values/dev.yaml --in config/common.yaml --out run/common/conf/common.yaml --dry-run
"""
