...
func CheckMatchReload(candidate *MatchConfig, current *MatchConfig) error {
	if candidate == nil || current == nil {
		return nil
	}
	if !reflect.DeepEqual(candidate.RouteragentSockPath, current.RouteragentSockPath) {
...
func CheckOnlineReload(candidate *OnlineConfig, current *OnlineConfig) error {
	if candidate == nil || current == nil {
		return nil
	}
	if !reflect.DeepEqual(candidate.RouteragentSockPath, current.RouteragentSockPath) {
...
func CheckRoomReload(candidate *RoomConfig, current *RoomConfig) error {
	if candidate == nil || current == nil {
		return nil
	}
	if !reflect.DeepEqual(candidate.RouteragentSockPath, current.RouteragentSockPath) {
...
func CheckRouteragentReload(candidate *RouteragentConfig, current *RouteragentConfig) error {
	if candidate == nil || current == nil {
		return nil
	}
