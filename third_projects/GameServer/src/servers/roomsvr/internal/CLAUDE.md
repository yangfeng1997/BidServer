...
本文件是 `third_projects/GameServer/src/servers/roomsvr/internal/` 的局部索引。进入本目录工作时，先读本文件，再按需读取相邻源码、测试或上级文档。
...
- [`game.go`](game.go)
- [`game_test.go`](game_test.go)
- [`reply.go`](reply.go)
- [`room_handler.go`](room_handler.go)
- [`room_handler_test.go`](room_handler_test.go)
- [`room_integration_test.go`](room_integration_test.go)
- [`room_module.go`](room_module.go)
