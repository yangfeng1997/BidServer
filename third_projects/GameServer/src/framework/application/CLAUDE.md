...
本文件是 `third_projects/GameServer/src/framework/application/` 的局部索引。进入本目录工作时，先读本文件，再按需读取相邻源码、测试或上级文档。
...
- [`application_test.go`](application_test.go)
- [`builder.go`](builder.go)
- [`forward_session_test.go`](forward_session_test.go)
