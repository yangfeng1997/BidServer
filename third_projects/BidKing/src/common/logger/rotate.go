...
// Sync 实现 zapcore.WriteSyncer，让 zapcore.AddSync 直接使用本对象而不套 writerWrapper
...
// shiftAndArchiveLocked 将 .1→.2, .2→.3 ... 然后把当前无后缀文件归档为 .1
...
// updateSymlinkLocked 更新 {Basename}.log → 当前写入文件。
