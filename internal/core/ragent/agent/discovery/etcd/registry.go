...
import (
	...
	"project/internal/core/ragent/agent/discovery"
	"project/pkg/logger"
...
func decodeNodeInfo(data []byte) (decodedNodeInfo, bool) {
	...
	return decodedNodeInfo{
		node:       discovery.NodeInfo{NodeID: id.Uint32(), RAAddr: info.RAAddr, StartAt: info.StartAt},
		serverType: info.ServerType,
	}, true
}

// Discover 拉取并 watch 节点
func (r *EtcdRegistry) Discover(onAdd func(discovery.NodeInfo, uint32), onDel func(uint32)) error {
